@sanity3
Feature: Check Campaign Count APi Response with Data Range
  Background:

  @sampleAPIs
  Scenario: Execute Count API and and assert fields with Data Range
    ...
    * header Content-Type = 'application/json'
    ...
    And request '{"community_id":"60862","start_date":"2022-11-04","end_date":"2023-11-05","campaign_id":584,"communityTimeZone":"America/New_York"}'
    When method post
    Then status 200
    * print response
