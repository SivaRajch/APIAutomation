@sort
Feature: Check Campaign Sorting response(Statu ended with all Visitor Types)
  Background:

  @sampleAPIs
  Scenario: Execute Results view and assert fields(Statu ended with all visitor types)
