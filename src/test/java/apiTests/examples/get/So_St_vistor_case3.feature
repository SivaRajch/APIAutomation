@sort
Feature: Check Campaign Sorting response(Status ended with all Guest, Service Providers)
  Background:

  @sampleAPIs
  Scenario: Execute Results view and assert fields(Status ended with all Guest, Service Providers)
